...
final class Telegram
{
    ...
    public function request(string $method, array $data): array
    {
        ...
        $r = $this->http->post('https://api.telegram.org/bot' . $this->config->get('BOT_TOKEN') . '/' . $method, ['Content-Type: application/json'], json_encode($data, JSON_UNESCAPED_UNICODE | JSON_THROW_ON_ERROR));
        return $r['data'];
    }
